...
[npc_op1,Kaqemeex]
	...
	if (questcompleted(DruidicRitual)) {
		chatnpc("Hello again. How is the Herblore going?");
		switch(menu("Very well, thank you.", "I need more practice at it...", "Can you explain the fundamentals again?", "What must I do to wear a Herblore skillcape?")) {
		case 0:
